...
prod_workspace = FabricRestApi.get_workspace_info(EnvironmentSettings.WORKSPACE_ID_PROD)
PROD_WORKSPACE_NAME = prod_workspace['displayName']
workspace_desciption = prod_workspace['description']
...
FEATURE_WORKSPACE_NAME = F'{PROD_WORKSPACE_NAME}-{FEATURE_NAME}'
