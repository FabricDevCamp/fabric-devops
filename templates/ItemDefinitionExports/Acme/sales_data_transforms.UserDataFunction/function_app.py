...
def ingest_csv_files(sales: fn.FabricLakehouseClient, url: str) -> str:
    ...
    if csv_base_url is None:
        csv_base_url = 'https://fabricdevcamp.blob.core.windows.net/sampledata/ProductSales/Dev/'

    logging.info(f'Coping CSV files with sales data from {csv_base_url}')
    ...
    for csv_file in csv_files:
        ...
        with requests.get(csv_file_path) as response:   
            ...
            logging.info(f'Saving {csv_file} to lakehouse at {folder_path + csv_file}')            
