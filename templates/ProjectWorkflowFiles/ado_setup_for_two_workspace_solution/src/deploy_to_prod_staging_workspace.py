...
AppLogger.log_job("Publihing all items to prod staging with fabric_cicd after PR completion")
...
CONFIG_FILE_PATH = str(Path(__file__).resolve().parent.parent / "workspace//staging//deploy.yml")
