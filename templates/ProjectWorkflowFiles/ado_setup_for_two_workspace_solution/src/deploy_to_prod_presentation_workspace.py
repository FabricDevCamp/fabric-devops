...
AppLogger.log_job("Publishing all items to prod presentation with fabric_cicd after PR completion")
...
CONFIG_FILE_PATH = str(Path(__file__).resolve().parent.parent / "workspace//presentation//deploy.yml")
