"""Setup project with fabric-cicd and GitFlow """
import os
...
match GIT_INTEGRATION_PROVIDER:
    ...
    case 'Azure DevOps':
        ...
        DeploymentManager.setup_ado_repo_with_fabric_cicd_and_gitflow(
            PROJECT_NAME,
            SOLUTION_NAME,
    ...
    case 'GitHub':
        ...
        DeploymentManager.setup_github_repo_with_fabric_cicd_and_gitflow(
            PROJECT_NAME,
            SOLUTION_NAME,
            CREATE_FEATURE_WORKSPACE
        )
