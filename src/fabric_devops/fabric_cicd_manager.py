...
class FabricCicdManager:
    ...
    @classmethod
    def deploy(cls, solution_folder: str, deploy_target: str = "dev", workspace_id: str = None):
        ...
        config_file_path = f".//templates//FabricSolutions//{solution_folder}/deploy.yml"
    ...
    @classmethod
    def deploy_to_existing_workspace(cls, solution_folder: str, target_workspace: str, environment: str = "dev"):
    ...
    @classmethod
    def deploy_to_new_workspace(cls, solution_folder: str, target_workspace: str, environment: str = "dev"):
