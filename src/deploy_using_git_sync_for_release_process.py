"""Setup project with GIT-sync for release process """
import os
...
match GIT_INTEGRATION_PROVIDER:
    ...
    case 'Azure DevOps':
        ...
        DeploymentManager.setup_ado_repo_with_git_sync_release_process(
            PROJECT_NAME,
            SOLUTION_NAME,
    ...
    case 'GitHub':
        ...
        DeploymentManager.setup_github_repo_with_git_sync_release_process(
            PROJECT_NAME,
            SOLUTION_NAME,
            CREATE_FEATURE_WORKSPACE 
        )
